...
public class ClienteActivity extends AppCompatActivity {
    ...
    private void selectItem(String title) {
        // Enviar titulo como arguemento del fragmento
        Bundle args = new Bundle();
        args.putString(ClienteBuscarFragment.ARG_SECTION_TITLE, title);
        Fragment fragment = ClienteBuscarFragment.newInstance(title);
